                            ...
                            <nav class="navigation post-navigation" aria-label="Posts">
                                <div class="nav-links d-flex justify-content-between">
                                    @foreach (['prev' => $prevNews, 'next' => $nextNews] as $rel => $news)
                                        @if ($news)
                                            <div class="nav-{{ $rel }}">
                                                <a href="{{ route('what-we-do.teaching-leadings-detail', [
                                ...
                                @foreach ($latestNews as $latestNew)
                                    <li class="news_li">
                                        <a class="newspost-title"
                                            href="{{ route('what-we-do.teaching-leadings-detail', ['locale' => session('locale', 'en'), 'id' => $latestNew->id]) }}">{{ GoogleTranslate::trans($latestNew->title, app()->getLocale()) }}</a>
                                    </li>
                                @endforeach
