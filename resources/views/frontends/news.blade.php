            ...
            <div class="row">
                ...
                <section id="primary" class="content-area col-sm-12 col-lg-12">
                    <main id="main" class="site-main" role="main">
                        ...
                        <h1 class="entry-title mb-5">{{ GoogleTranslate::trans($sectionSetting?->title ?? __('app.News'), app()->getLocale()) }}</h1>
                        <div class="row gx-5">
                            @foreach ($news as $post)
                                <div class="project_single col-md-4">
                                    <h3><a
                                            href="{{ route('media-notices.news-detail', ['locale' => session('locale', 'en'), 'new' => $post->id]) }}">{{ GoogleTranslate::trans($post->title, app()->getLocale()) }}</a>
                                    </h3>
