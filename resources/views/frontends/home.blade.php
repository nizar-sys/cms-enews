        ...
        <section id="hero" class="hero section dark-background">
            ...
            <div id="hero-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
                ...
                <div class="carousel-item active">
                    <img src="{{ asset('/ac') }}/assets/img/hero_1.jpg" alt="">
                ...
                <div class="carousel-item">
                    <img src="{{ asset('/ac') }}/assets/img/hero_2.jpg" alt="">
                    <div class="carousel-container">
                ...
                <div class="carousel-item">
                    <img src="{{ asset('/ac') }}/assets/img/hero_3.jpg" alt="">
                    <div class="carousel-container">
                ...
                <div class="carousel-item">
                    <img src="{{ asset('/ac') }}/assets/img/hero_4.jpg" alt="">
                    <div class="carousel-container">
                ...
                <div class="carousel-item">
                    <img src="{{ asset('/ac') }}/assets/img/hero_5.jpg" alt="">
                    <div class="carousel-container">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="service-item">
                                ...
                                <div class="service-item-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" width="80" height="80" x="0"
                                        y="0" viewBox="0 0 512.805 512.805" style="enable-background: new 0 0 512 512"
                                        xml:space="preserve" class="">
                                        <g>
                                            <path
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 mb-4 mb-lg-0">
                            <img src="{{ asset('/ac') }}/assets/img/img_long_5.jpg" alt="Image "
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="service-item">
                                    ...
                                    <img src="{{ asset('/ac') }}/assets/img/img_sq_1.jpg" alt="Image"
                                        class="img-fluid">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="service-item">
                                    ...
                                    <img src="{{ asset('/ac') }}/assets/img/img_sq_3.jpg" alt="Image"
                                        class="img-fluid">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="service-item">
                                    ...
                                    <img src="{{ asset('/ac') }}/assets/img/img_sq_8.jpg" alt="Image"
                                        class="img-fluid">
                                </div>
                            </div>
                            ...
                            <div class="swiper-slide">
                                <div class="service-item">
                                    ...
                                    <img src="{{ asset('/ac') }}/assets/img/img_sq_4.jpg" alt="Image"
                                        class="img-fluid">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="service-item">
                                    ...
                                    <img src="{{ asset('/ac') }}/assets/img/img_sq_5.jpg" alt="Image"
                                        class="img-fluid">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="service-item">
                                    ...
                                    <img src="{{ asset('/ac') }}/assets/img/img_sq_6.jpg" alt="Image"
                                        class="img-fluid">
                                </div>
                            </div>
                            <div class="swiper-slide">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-4 mb-md-4">
                            <div class="testimonial">
                                <img src="{{ asset('/ac') }}/assets/img/testimonials/testimonials-1.jpg"
                        ...
                        <div class="col-md-6 mb-4 mb-md-4">
                            <div class="testimonial">
                                <img src="{{ asset('/ac') }}/assets/img/testimonials/testimonials-2.jpg"
                                    alt="Testimonial author">
                                <blockquote>
                                    <p>
                                        “Lorem ipsum dolor sit, amet consectetur adipisicing
                        ...
                        <div class="col-md-6 mb-4 mb-md-4">
                            <div class="testimonial">
                                <img src="{{ asset('/ac') }}/assets/img/testimonials/testimonials-3.jpg"
                                    alt="Testimonial author">
                                <blockquote>
                                    <p>
                                        “Lorem ipsum dolor sit, amet consectetur adipisicing
                        ...
                        <div class="col-md-6 mb-4 mb-md-4">
                            <div class="testimonial">
                                <img src="{{ asset('/ac') }}/assets/img/testimonials/testimonials-4.jpg"
                                    alt="Testimonial author">
                                <blockquote>
                                    <p>
                                        “Lorem ipsum dolor sit, amet consectetur adipisicing
                ...
                <div class="row gy-5">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="post-item position-relative h-100" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <div class="post-img position-relative overflow-hidden">
                                <img src="{{ asset('/ac') }}/assets/img/blog/blog-1.jpg" class="img-fluid"
                                    alt="">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="post-item position-relative h-100" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div class="post-img position-relative overflow-hidden">
                                <img src="{{ asset('/ac') }}/assets/img/blog/blog-2.jpg" class="img-fluid"
                                    alt="">
                    ...
                    <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                        <div class="post-item position-relative h-100">
                            ...
                            <div class="post-img position-relative overflow-hidden">
                                <img src="{{ asset('/ac') }}/assets/img/blog/blog-3.jpg" class="img-fluid"
                                    alt="">
