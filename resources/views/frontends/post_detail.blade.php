                ...
                <div class="container position-relative">
                    ...
                    <nav class="breadcrumbs">
                        <ol>
                            ...
                            <li class="current">Post Detail</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <aside id="secondary" class="widget-area col-sm-12 col-lg-4" role="complementary">
                        ...
                        <div id="social-buttons">
                            ...
                            <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(Request::fullUrl()) }}&quote={{ urlencode($post->title ?? '') }}"
                                class="social-button facebook" title="Share on Facebook" rel="nofollow noopener noreferrer"
                                target="_blank">
                            ...
                            <div class="comment-item"
                                ...
                                <div id="reply-form-{{ $comment->id }}" style="display: none; margin-top: 10px;">
                                    <form
                                        ...
                                        <button
                                            style="background-color: #007bff; color: #fff; padding: 8px 12px; border: none; border-radius: 4px; margin-top: 5px; cursor: pointer;">Post
                                            Reply</button>
                                    </form>
                                </div>
                    ...
                    <div class="comment-section"
                        ...
                        @auth
                            <form method="POST"
                                ...
                                <textarea name="comment" rows="5" placeholder="Write your comment here..." required
                                    style="width: 100%; padding: 10px; border-radius: 4px; border: 1px solid #ccc; resize: none;"></textarea>
                                <button type="submit"
                                    style="background-color: #007bff; color: #fff; padding: 8px 12px; border: none; border-radius: 4px; cursor: pointer;">Submit
                                    Comment</button>
                            </form>
                        @else
                            <p style="color: #777;">Please <a href="{{ route('login') }}" style="color: #007bff;">log in</a> to
                                leave a comment.</p>
                        @endauth
                    </div>
