...
@section('title', GoogleTranslate::trans('Monitoring Evaluation', app()->getLocale()))
        ...
        <div class="page-title dark-background" data-aos="fade" style="background-color: #2c4666">
            <div class="container position-relative">
                ...
                <div style="word-wrap: break-word;">
                    {{ GoogleTranslate::trans($monitoringEvaluation?->title ?? 'Read More', app()->getLocale()) }}
                </div>
        ...
        <div class="container">
            <div class="row">
                <section id="primary" class="content-area col-sm-12 col-lg-12">
                    <h1>{{ GoogleTranslate::trans($monitoringEvaluation?->title ?? 'Read More', app()->getLocale()) }}</h1>
                    <main id="main" class="site-main" role="main">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8 position-relative text-center" data-aos="zoom-out">
                                    <img src="{{ $monitoringEvaluation ? asset($monitoringEvaluation->image) : asset('/ac/assets/img/img_sq_1.jpg') }}"
                                        alt="Image" class="img-fluid thumbnail-image"
                                        style="max-width: 100%; height: auto; max-height: 400px; object-fit: cover;">

                                    <a href="{{ $monitoringEvaluation ? $monitoringEvaluation->video_url : 'https://www.youtube.com/watch?v=LXb3EKWsInQ' }}"
