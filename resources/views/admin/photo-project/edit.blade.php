...
@section('title', 'Photo Project')

@section('content')
    <section class="section">
        <div class="section-header">
            <div class="section-header-back">
                <a href="{{ route('admin.photo-project.index') }}" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
            </div>
            <h1>Photo Project</h1>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Edit Photo Project</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('admin.photo-project.update', $photo->id) }}" method="POST"
