        ...
        success: function (response) {
          ...
          if (response.length > 0) {
            ...
            response.forEach((item) => {
              let resultHtml = `<a class="col-md-12 mb-3" ${
                item.isFile ? 'target="_blank"' : ""
              } href="${item.detail}">
                                    <div class="card">
                                        <div class="card-body">
                                            <h5 class="card-title">${
...
document
  .querySelectorAll(".navbar-nav .nav-link, .navbar-nav .dropdown-item")
  .forEach((link) => {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  menuItems.forEach(function (item) {
    item.addEventListener("mouseover", function () {
      item.style.backgroundColor = "rgba(63, 162, 246, 0.7)"; // Warna background dengan opacity 0.7
    });
  ...
  subMenuItems.forEach(function (subItem) {
    subItem.addEventListener("mouseover", function () {
      subItem.style.backgroundColor = "rgba(63, 162, 246, 0.7)"; // Warna background dengan opacity 0.7
    });
    subItem.addEventListener("mouseout", function () {
      subItem.style.backgroundColor = "transparent"; // Kembali ke background transparan
    });
  });
});
