...
class BidChallengeSystemDataTable extends DataTable
{
    /**
     ...
     */
    public function query(BidChallengeSystem $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
            ->setTableId('bidchallengesystem-table')
            ...
            ->parameters([
                ...
                'buttons' => [
                    ...
                    [
                        ...
                        'action' => 'function(){
                            var table = window.LaravelDataTables["bidchallengesystem-table"];
                            table.ajax.reload();
    ...
    {
        return 'BidChallengeSystem_' . date('YmdHis');
    }
}
