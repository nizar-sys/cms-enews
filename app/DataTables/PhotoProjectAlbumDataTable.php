...
class PhotoProjectAlbumDataTable extends DataTable
{
     ...
     */
    public function query(PhotoProjectAlbum $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
            ->setTableId('PhotoProjectAlbum-table')
    ...
    {
        return 'PhotoProjectAlbum_' . date('YmdHis');
    }
}
