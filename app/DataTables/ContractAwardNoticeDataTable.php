...
class ContractAwardNoticeDataTable extends DataTable
{
    /**
     ...
     */
    public function query(ContractAwardNotice $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
            ->setTableId('contractawardnotice-table')
            ...
            ->parameters([
                ...
                'buttons' => [
                    ...
                    [
                        ...
                        'action' => 'function(){
                            var table = window.LaravelDataTables["contractawardnotice-table"];
                            table.ajax.reload();
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('file_name')->title('File Name')
                ->searchable(true)
                ->orderable(true),
            Column::make('posted_on')->title('Posted On'),
            Column::make('file_path')->title('Download'),
    ...
    {
        return 'ContractAwardNotice_' . date('YmdHis');
    }
}
