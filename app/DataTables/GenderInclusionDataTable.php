...
class GenderInclusionDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addIndexColumn()
            ->addColumn('action', 'admin.gender-inclusion.actions')
            ->addIndexColumn()
            ->rawColumns(['action']);
    }
     ...
     */
    public function query(GenderInclusion $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
            ->setTableId('gender-inclusion-table')
    ...
    {
        return 'GenderInclusion_' . date('YmdHis');
    }
}
