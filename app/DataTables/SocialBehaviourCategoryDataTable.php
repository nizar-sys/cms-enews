...
class SocialBehaviourCategoryDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', 'admin.social-behaviour.category.actions')
            ->addIndexColumn()
            ->rawColumns(['action']);
    }
     ...
     */
    public function query(SocialBehaviourCategory $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
            ->setTableId('social-behaviour-category-table')
