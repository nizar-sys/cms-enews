...
class SocialBehaviourDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addIndexColumn()
            ->addColumn('action', 'admin.social-behaviour.actions')
            ->addIndexColumn()
            ->rawColumns(['action']);
    }
     ...
     */
    public function query(SocialBehaviour $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
            ->setTableId('social-behaviour-table')
