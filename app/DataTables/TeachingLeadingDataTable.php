...
class TeachingLeadingDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($query) {
                return '<a href="' . route('admin.teaching-leading.edit', $query->id) . '" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i></a>
                     <a href="' . route('admin.teaching-leading.destroy', $query->id) . '" class="btn btn-sm btn-danger delete-item"><i class="fas fa-trash"></i></a>';
            })
            ->setRowId('id')
     ...
     */
    public function query(TeachingLeading $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
            ->setTableId('teaching-leading-table')
            ...
            ->parameters([
                ...
                'buttons' => [
                    ...
                    [
                        ...
                        'action' => 'function(){
                                 var table = window.LaravelDataTables["teaching-leading-table"];
                                 table.ajax.reload();
    ...
    {
        return 'TeachingLeading' . date('YmdHis');
    }
}
