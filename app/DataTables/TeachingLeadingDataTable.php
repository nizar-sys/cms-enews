        ...
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($query) {
                return '<div class="d-flex align-items-center">
                            <a href="' . route('admin.teaching-leading.edit', $query->id) . '" class="btn btn-sm btn-primary mr-2">
                                <i class="fas fa-edit"></i>
                            </a>
                            <a href="' . route('admin.teaching-leading.destroy', $query->id) . '" class="btn btn-sm btn-danger delete-item">
