...
class GenderInclusionCategoryDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', 'admin.gender-inclusion.category.actions')
            ->addIndexColumn()
            ->rawColumns(['action']);
    }
     ...
     */
    public function query(GenderInclusionCategory $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
            ->setTableId('gender-inclusion-category-table')
