...
class MonitoringEvaluationCategoryDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', 'admin.monitoring-evaluation.category.actions')
            ->addIndexColumn()
            ->rawColumns(['action']);
    }
     ...
     */
    public function query(MonitoringEvaluationCategory $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
            ->setTableId('monitoring-evaluation-category-table')
            ...
            ->parameters([
                ...
                'buttons' => [
                    ...
                    [
                        ...
                        'action' => 'function(){
                                    var table = window.LaravelDataTables["category-table"];
                                    table.ajax.reload();
